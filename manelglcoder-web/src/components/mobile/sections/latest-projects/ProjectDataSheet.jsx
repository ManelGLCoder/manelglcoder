...
import { TEXT_SUB_TITLE, TEXT_NORMAL, TEXT_CENTERED_WITH_ICON } from '../../../../utilities/classname_utilities'
    ...
    return(
        <section className='flex flex-col gap-1 my-2'>
            <div className="flex gap-1 items-center">
                <IconSized src={PlatformIcon} alt={'Platform Icon'}/>
            ...
            <div className="flex gap-1 items-center">
                <IconSized src={PlayersIcon} alt={'Players Icon'}/>
            ...
            <div className="flex gap-1 items-center">
                <IconSized src={GenreIcon} alt={'Genre Icon'}/>
